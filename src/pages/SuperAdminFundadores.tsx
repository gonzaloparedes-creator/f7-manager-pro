...
export default function SuperAdminFundadores() {
  ...
  async function load() {
    ...
    const { data: companiesData, error } = await supabase
      .from("companies")
      .select("id, name, created_at, plan_type, is_active, founder_cohort_at, is_paying")
      .eq("founder_cohort", true)
      .order("founder_cohort_at", { ascending: false });
    if (error) {
    ...
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="mx-auto max-w-6xl space-y-6 animate-fade-in">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Embudo de activación del Programa Fundadores. Marcá empresas como Fundador desde Master Admin.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <Card className="p-4">
            <div className="text-xs text-muted-foreground">Fundadores</div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Fundador desde</TableHead>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    <TableRow><TableCell colSpan={9} className="text-center text-muted-foreground py-8">Sin Fundadores todavía. Marcalos desde Master Admin.</TableCell></TableRow>
                  ) : filtered.map((c) => {
                    ...
                    return (
                      <TableRow key={c.id}>
                        ...
                        <TableCell className="text-muted-foreground">
                          {c.founder_cohort_at ? new Date(c.founder_cohort_at).toLocaleDateString("es-PY") : "—"}
                        </TableCell>
